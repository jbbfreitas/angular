...
Implementamos dois casos de uso: "Listar Municipios" e "Criar um novo município". Isso foi possível graças ao uso de `Routing`. Na próxima versão [V6](angular/angular-forms-6/README.md)  vamos criar um novo calso de uso: "Excluir Municipios".
