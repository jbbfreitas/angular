...
```
- Exexcute o comando `ng serve` e digite a url no seu browser  `localhost:4200`. Abra a console do navegar, usando as instruções abaixo e clique no botão `Gravar`.
```
